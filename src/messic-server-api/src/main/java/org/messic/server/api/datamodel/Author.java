...
public class Author
{
    ...
    public Author( MDOAuthor mdoauthor, boolean copyAlbums, boolean copySongs )
    {
        ...
        if ( copyAlbums )
        {
            ...
            albums.addAll( mdoauthor.getAlbums() );
            java.util.Collections.sort( albums, new Comparator<MDOAlbum>()
            {
                @Override
                public int compare( MDOAlbum o1, MDOAlbum o2 )
                {
            ...
            {
                MDOAlbum mdoAlbum = albums.get( i );
