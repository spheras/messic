    ...
    extends DAO<MDOAuthor>
{
     ...
     * @param contains boolean flag to indicate if the authorName is a partial search with any authorname wich contains
     *            the words of the param, or starting
    ...
    /**
     * Search an author with the same location
     * 
     * @param location {@link String} location to search
     * @param username {@link String} user scope
     * @return {@link MDOAuthor} found, null if none
     */
    @Transactional
    MDOAuthor getAuthorByLocation( String location, String username );
