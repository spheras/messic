...
var WizardMatcher = function () {
    ...
    */
    this.wizardmatch = function (selectedDiv) {
        //first we match the general info
        matchGeneralInfo(selectedDiv);
        ...
        this.divtracksO = $("#messic-upload-wizard-albuminfo-body .messic-upload-wizard-albumsong-track");
        this.divnamesO = $("#messic-upload-wizard-albuminfo-body .messic-upload-wizard-albumsong-name");
        ...
        for(var s=0;s<this.divtracksS.length;s++){
            ...
            if(repeatedListTrackS.length==1 && repeatedListTrackO.length==1){
                ...
                utilFindNameDivOrigin(repeatedListTrackO[0]).val(utilFindNameDivOrigin(repeatedListTrackS[0]).text());
    ...
    */
    var matchGeneralInfo=function(selectedDiv){
