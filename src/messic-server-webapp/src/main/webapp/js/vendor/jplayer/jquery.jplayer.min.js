...
*/
        ...
        format: { // Static Object
            mp3: {
                //codec: 'audio/mpeg; codecs="mp3"', MESSIC, ANDROID SEEMS TO BE COMPATIBLE WITHOUT THE -CODECS="MP3"-
                //also, read this:
        ...
        _init: function () {
            ...
            $.each(this.formats, function (priority, format) {
                ...
                //TEMPORAL
                //alert(format + ":" + self.html.canPlay[format]);
                //alert("available:" + self.html[self.format[format].media].available);
                //alert("codec:" + self.format[format].codec);
                //alert("media:" + self.format[format].media);
                //alert("canplay:" + self.htmlElement[self.format[format].media].canPlayType(self.format[format].codec));
      ...
      '<param name="wmode" value="' + this.options.wmode + '" />'
        ...
        _addHtmlEventListeners: function (mediaElement, entity) {
            ...
            mediaElement.addEventListener("error", function (ev) {
                if (entity.gate) {
                    self._updateButtons(false);
                    self._seeked();
                ...
                $.each(self.solutions, function (solutionPriority, solution) {
                    if (self[solution].support[format] && self._validString(media[format])) { // Format supported in solution and url given for format.
                        ...
                        if (isVideo) {
                            ...
                            if (isHtml) {
                            	//messic temporal
                            	//alert("is html: " + media.mp3);
                            	var rmedia={
                               		title:"Bubble",
                            		mp3:media.mp3,
                            	}
                                self.html.audio.gate = true;
                                self._html_setAudio(rmedia);
                                self.html.active = true;
        ...
        _html_initMedia: function (media) {
            ...
            //messic temporal
            //alert("setting media:" + this.htmlElement.media.src);
        ...
        _html_setFormat: function (media) {
            ...
            $.each(this.formats, function (priority, format) {
                if (self.html.support[format] && media[format]) {
                    ...
                    //messic temporal
                	//alert("status:"+self.status.src+","+self.status.format[format]+","+self.status.formatType);
                    return false;
                }
            });
        },
        ...
        _html_play: function (time) {
            ...
            if (this.androidFix.setMedia && false) { //MESSIC, it seems that in (at least) recents versions of android (with the native android navigator), this hack is problematic.
