...
(function ($)
{
    ...
    function Plugin($container, options)
    {
        ...
        //MESSIC , see https://github.com/wieringen/tinyscrollbar/issues/25
        ...
        this.messic_moveleft=function(){
        	var cant=self.viewportSize/2;
        	if(cant<94){
        		cant=94;
        	}
            self.contentPosition -= cant;
            messic_move();
        }
        this.messic_moveright=function(){
        	var cant=self.viewportSize/2;
        	if(cant<94){
        		cant=94;
        	}
