	        	...
	        	if(data[0]){
	        		...
	        		if(playlist.songs){
		        		for(var j=0;j<playlist.songs.length;j++){
		        			...
		        			code=code+"<li class=\"messic-albumentity-container\" draggable=\"true\" data-sid=\""+song.sid+"\">";
		            		...
		            		code=code+"      <div class=\"messic-albumentity-add\" onclick=\"if(event){event.stopPropagation();}addSong('raro',";
