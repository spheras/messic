...
var UploadPool = function () {
    ...
    this.addUpload = function (albumCode, uploadResource, successFunction, errorFunction, xhrFunction) {
        var element = {
    ...
    this.runElement = function (element) {
        ...
        reader.onload = function (e) {
            ...
            $.ajax({
                url: 'services/albums/' + element._albumCode + "?fileName=" + encodeURIComponent(element._uploadResource.file.name) + "&volume=" + element._uploadResource.volume,
                type: 'PUT',
                //Ajax events
                success: function () {
        ...
        reader.readAsArrayBuffer(element._uploadResource.file);
    }
}