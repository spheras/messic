 ...
 */
public class MusicFoldersContainer extends VisualContainer {
     ...
     */
    public MusicFoldersContainer(Filter filter) {
        this(filter, CommonContentManager.AUDIO_FOLDERS_ID, CommonContentManager.AUDIO_ID);
    }
     ...
     */
    public MusicFoldersContainer(Filter filter, String id, String parentId) {
        super();
