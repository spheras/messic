 ...
 */
public class TranscoderServiceImpl
    implements TranscoderService
{
    ...
    // Logger
    private Logger logger = Logger.getLogger( TranscoderServiceImpl.class );
    ...
    public boolean isValidMedia( String client, Movie movie )
    {
        ...
        // ((AudioCodec.match(audioFormat, audioFormatProfile, audioFormatVersion, audioCodec, AudioCodec.AC3) &&
        // audioChannels <= 6)
        ...
        // VideoCodec.match(videoFormat, videoFormatProfile, videoFormatVersion, videoCodec, VideoCodec.MPEG4_P2) &&
        // ((AudioCodec.match(audioFormat, audioFormatProfile, audioFormatVersion, audioCodec, AudioCodec.AAC_LC) &&
        // audioChannels <= 2)) &&
        // videoBitRate <= 5000000 && videoWidth <= 1280 && videoHeight <= 720 && fps <= 30) {
        // return true;
        // }
        ...
        // ((AudioCodec.match(audioFormat, audioFormatProfile, audioFormatVersion, audioCodec, AudioCodec.WMA) &&
        // audioChannels <= 6)) &&
    ...
    @Override
    public String getVideoMIME( String container, String videoFormat, String videoFormatProfile,
                                int videoFormatVersion, String videoCodec )
    {
        return MIME.getVideoMime( container, videoFormat, videoFormatProfile, videoFormatVersion, videoCodec );
    }

    @Override
    public DLNAProfiles getAudioProfile( String container, String audioFormat, String audioFormatProfile,
                                         int audioFormatVersion, String audioCodec, long audioBitRate,
                                         long audioSampleBitRate, int audioChannels )
    {
        DLNAProfiles profile = DLNAProfiles.NONE;
        for ( AudioCatalog audioCatalog : audioCatalogs )
        {
            profile =
                audioCatalog.resolve( container, audioFormat, audioFormatProfile, audioFormatVersion, audioCodec,
                                      audioBitRate, audioSampleBitRate, audioChannels );
    ...
    @Override
    public DLNAProfiles getVideoProfile( String container, String videoFormat, String videoFormatProfile,
                                         int videoFormatVersion, String videoCodec, long videoBitRate, int videoWidth,
                                         int videoHeight, float fps, String audioFormat, String audioFormatProfile,
                                         int audioFormatVersion, String audioCodec, long audioBitRate,
                                         long audioSampleBitRate, int audioChannels )
    {
        DLNAProfiles audioProfile =
            this.getAudioProfile( container, audioFormat, audioFormatProfile, audioFormatVersion, audioCodec,
                                  audioBitRate, audioSampleBitRate, audioChannels );
        DLNAProfiles profile = DLNAProfiles.NONE;
        // for (VideoCatalog videoCatalog : videoCatalogs) {
        // profile = videoCatalog.resolve(container, videoFormat, videoFormatProfile, videoFormatVersion, videoCodec,
        // videoBitRate, videoWidth, videoHeight, fps,
        // audioFormat, audioFormatProfile, audioFormatVersion, audioCodec, audioBitRate, audioSampleBitRate,
    ...
    public DLNAProfiles getVideoTranscodedProfile( String client, Movie movie )
    {
        ...
        // } else if (AudioCodec.match(audioFormat, audioFormatProfile, audioFormatVersion, audioCodec,
        // AudioCodec.MP3X)) {
        ...
        // return DLNAProfiles.MPEG4_P2_MP4_ASP_AAC;
        // }
        // } else if (VideoCodec.match(videoFormat, videoFormatProfile, videoFormatVersion, videoCodec,
        // VideoCodec.MPEG4_P10)) {
    ...
    public List<TranscoderProcess> getTranscodedProcesses( String client, Movie movie )
    {
        ...
        // scriptTemplate = new ScriptTemplate(inputFiles, outputFile, scriptFile, new VideoCopyConfig(), new
        // AudioCopyConfig());
        ...
        // scriptTemplate.setContainer("AVI");
        // } else if (AudioCodec.match(audioFormat, audioFormatProfile, audioFormatVersion, audioCodec,
        // AudioCodec.AAC_LC) && audioChannels <= 2) {
        ...
        // VideoCodec.MPEG4_P10) &&
        // videoBitRate <= 10000000 && videoWidth <= 1920 && videoHeight <= 1080 && fps <= 30) {
        // if (AudioCodec.match(audioFormat, audioFormatProfile, audioFormatVersion, audioCodec, AudioCodec.AAC_LC) &&
        // audioChannels <= 2) {
        // outputFile = new File(tempDirectory, UUID.randomUUID().toString() + ".mp4");
        // scriptTemplate = new ScriptTemplate(inputFiles, outputFile, scriptFile, new VideoCopyConfig(), new
        // AudioCopyConfig());
    ...
    @Override
    public ImageTranscoderProcess getImageTranscodedProcess( String client, File imageFile, String imageType,
    ...
    @Override
    public DLNAProfiles getVideoTranscodedProfile( String client, String container, String videoFormat,
                                                   String videoFormatProfile, int videoFormatVersion,
                                                   String videoCodec, long videoBitRate, int videoWidth,
                                                   int videoHeight, float fps, String audioFormat,
                                                   String audioFormatProfile, int audioFormatVersion,
                                                   String audioCodec, long audioBitRate, long audioSampleBitRate,
                                                   int audioChannels )
    {
        // if (client.equals(PROFILE_XBOX)) {
        // if (VideoCodec.match(videoFormat, videoFormatProfile, videoFormatVersion, videoCodec, VideoCodec.MPEG4_P2) &&
    ...
    @Override
    public String getVideoTranscodedMime( String client, String container, String videoFormat,
                                          String videoFormatProfile, int videoFormatVersion, String videoCodec,
                                          long videoBitRate, int videoWidth, int videoHeight, float fps,
                                          String audioFormat, String audioFormatProfile, int audioFormatVersion,
                                          String audioCodec, long audioBitRate, long audioSampleBitRate,
                                          int audioChannels )
    {
        if ( client.equals( PROFILE_XBOX ) )
