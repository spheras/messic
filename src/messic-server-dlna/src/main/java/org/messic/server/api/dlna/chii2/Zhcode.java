...
public class Zhcode
    extends Encoding
{
    private Logger log = Logger.getLogger( Zhcode.class );
    ...
    // Logger
    protected Logger logger = Logger.getLogger( Zhcode.class );
    ...
    public void convertStringBuffer( StringBuffer dataline, int source_encoding, int target_encoding )
    {
        ...
        for ( lineindex = 0; lineindex < dataline.length(); lineindex++ )
        {
            ...
            if ( ( source_encoding == GB2312 || source_encoding == GBK || source_encoding == ISO2022CN_GB
                || source_encoding == HZ || source_encoding == GB18030 || source_encoding == UNICODE
                    ...
                    || target_encoding == UTF8T || target_encoding == ISO2022CN_CNS ) )
            {
                ...
                || source_encoding == UTF8 || source_encoding == UTF8T || source_encoding == ISO2022CN_CNS
